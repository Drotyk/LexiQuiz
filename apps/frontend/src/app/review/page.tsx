  ...
  if (isAuthLoading || isLoading) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center">
        <div className="text-gray-400 font-mono animate-pulse">Checking due words...</div>
      </div>
    );
  }
      ...
      <main className="max-w-xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center space-y-6 shadow-2xl">
          ...
          <div className="pt-4">
            <Link
              href="/sets"
              className="inline-flex items-center space-x-2 px-6 py-3 rounded-xl bg-gray-500 hover:bg-gray-400 text-white font-semibold text-sm transition shadow-lg shadow-gray-500/20"
            >
  ...
  return (
    <main className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6 flex flex-col min-h-[calc(100vh-5rem)]">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs font-mono font-semibold text-gray-400 flex items-center gap-1">
